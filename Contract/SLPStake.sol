...
contract SLPStake is Owned, WhiteList {
    ...
    struct StakerState {
      ...
      /// @notice TThe reward pool put into by the project side 奖励
    uint256 public reward;
    /// @notice The number of token per-block 
    uint256 public rewardSpeed = 2.89e8;
    /// @notice Inital index  初始索引
    ...
    function setup(address _token,address _coin) public onlyWhiter {
     ...
     /**
     * @notice Get the number of debt by the `account` 获取某个账户当前在系统中质押币数量与铸币数量
